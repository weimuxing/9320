/*
	$Workfile:   SportsAccTbl.c  $
	$Revision: 1.7 $
	$Date: 2012/10/12 06:15:39 $
*/
#define __SPORTSACCTBL_C__
//******************************************************************************
...
/*
// Algorithm paramters
static gmt_ACC3Params ROM Acc3SportColorChemeParams =
{
    310,10,2,208,
...
gmt_ACC3Options ROM Acc3SportOptionsTbl = {
   8,
   1,0,1,0,0,0,0,1,
...
gmt_AccDescr ROM AccSport =
{
	(gmt_ACC3Params *)&Acc3SportColorChemeParams,
    (gmt_ACC3Options*)&Acc3SportOptionsTbl
};
*/
VQ_ACC_Parameters_t ROM AccSport =
{
   {
