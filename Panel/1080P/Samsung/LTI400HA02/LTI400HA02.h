/*
	$Workfile:   LTI400HA02.h  $
	$Revision:   1.0  $
	$Date:   May 12 2008 09:51:18  $		//Peter 10090120
*/
#ifdef INCLUDE_SAMSUNG_LTI400HA02

#include "..\..\Panel\1080P\Samsung\LTI400HA02\OverdriveLut.h"
#include "..\..\Panel\1080P\Samsung\LTI400HA02\GammaLut.h"


char ROM PanelName_SAMSUNG_LTI400HA02[] = "SAMSUNG_LTI400HA02";

ROM WORD sRGB2rgb_LTI400HA02[9] =
{
...
ROM gmt_PanelData Panel_1080P_SAMSUNG_LTI400HA02 =
{
	PanelName_SAMSUNG_LTI400HA02,	// Panel Name
	SAMSUNG_LTI400HA02,				// Panel ID (refer to enum defined in panel.h)
...
// @Modify By Ray --End-- 2010-04-26
	...
	Wa_OverDriveLUT_LTI400HA02, 	//OverDriveLut_LK520D3LZ8x,
	sRGB2rgb_LTI400HA02,
	Sta_GammaLUT_LTI400HA02,
	0,					//WORD  Invert_DVS 			: 1;
	0,					//WORD  Invert_DHS 			: 1;
...
extern ROM gmt_PanelData Panel_1080P_SAMSUNG_LTI400HA02;

#else
	#define Panel_1080P_SAMSUNG_LTI400HA02	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == SAMSUNG_LTI400HA02)
		#pragma message "Default panel will not bootup unless INCLUDE_SAMSUNG_LTI400HA02 is defined!"
	#endif
#endif
