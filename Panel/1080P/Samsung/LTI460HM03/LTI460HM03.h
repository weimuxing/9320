/*
	$Workfile:   LTI460HM03.h  $
	$Revision:   1.0  $
	$Date:   May 12 2008 09:51:18  $		//Peter 10090120
*/
#ifdef INCLUDE_SAMSUNG_1080P_LTI460HM03

#include "..\..\Panel\1080P\Samsung\LTI460HM03\OverdriveLut.h"
#include "..\..\Panel\1080P\Samsung\LTI460HM03\GammaLut.h"


char ROM PanelName_SAMSUNG_LTI460HM03[] = "SAMSUNG_LTI460HM03";

ROM WORD sRGB2rgb_LTI460HM03[9] =
{
...
ROM gmt_PanelData Panel_1080P_SAMSUNG_LTI460HM03 =
#if 1
{
	PanelName_SAMSUNG_LTI460HM03,	// Panel Name
	SAMSUNG_1080P_LTI460HM03,				// Panel ID (refer to enum defined in panel.h)
	...
	0,								//BYTE  DClkDelay;
	Wa_OverDriveLUT_LTI460HM03,		// Overdrive look up table
	sRGB2rgb_LTI460HM03,
	Sta_GammaLUT_LTI460HM03,
	0,								//WORD  Invert_DVS			: 1;
	0,								//WORD  Invert_DHS			: 1;
...
extern ROM gmt_PanelData Panel_1080P_SAMSUNG_LTI460HM03;
#else
	#define Panel_1080P_SAMSUNG_LTI460HM03	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == SAMSUNG_1080P_LTI460HM03)
		#pragma message "Default panel will not bootup unless INCLUDE_SAMSUNG_1080P_LTI460HM03 is defined!"
	#endif
#endif
