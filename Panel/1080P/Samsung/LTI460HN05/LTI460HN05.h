/*
	$Workfile:   LTI460HN05.h  $
	$Revision:   1.0  $
	$Date:   May 12 2008 09:51:18  $		//Peter 10090120
*/
#ifdef INCLUDE_SAMSUNG_1080P_LTI460HN05

#include "..\..\Panel\1080P\Samsung\LTI460HN05\OverdriveLut.h"
#include "..\..\Panel\1080P\Samsung\LTI460HN05\GammaLut.h"


char ROM PanelName_SAMSUNG_LTI460HN05[] = "SAMSUNG_LTI460HN05";

ROM WORD sRGB2rgb_LTI460HN05[9] =
{
...
ROM gmt_PanelData Panel_1080P_SAMSUNG_LTI460HN05 =
{
	PanelName_SAMSUNG_LTI460HN05,	// Panel Name
	SAMSUNG_1080P_LTI460HN05,				// Panel ID (refer to enum defined in panel.h)
	...
	0,								//BYTE  DClkDelay;
	Wa_OverDriveLUT_LTI460HN05,		// Overdrive look up table
	sRGB2rgb_LTI460HN05,
	Sta_GammaLUT_LTI460HN05,
	0,								//WORD  Invert_DVS			: 1;
	0,								//WORD  Invert_DHS			: 1;
...
extern ROM gmt_PanelData Panel_1080P_SAMSUNG_LTI460HN05;
#else
	#define Panel_1080P_SAMSUNG_LTI460HN05	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == SAMSUNG_1080P_LTI460HN05)
		#pragma message "Default panel will not bootup unless INCLUDE_SAMSUNG_1080P_LTI460HN05 is defined!"
	#endif
#endif
