/*
	$Workfile:   LTI460HJ01_120HZ.h  $
	$Revision:   1.0  $
	$Date:   May 12 2008 09:51:18  $		//Peter 10090120
*/
#ifdef INCLUDE_SAMSUNG_LTI460HJ01_120HZ

#include "..\..\Panel\1080P\Samsung\LTI460HJ01_120HZ\OverdriveLut.h"
#include "..\..\Panel\1080P\Samsung\LTI460HJ01_120HZ\GammaLut.h"


char ROM PanelName_SAMSUNG_LTI460HJ01_120HZ[] = "SAMSUNG_LTI460HJ01_120HZ";

ROM WORD sRGB2rgb_LTI460HJ01_120HZ[9] =
{
...
ROM gmt_PanelData Panel_1080P_SAMSUNG_LTI460HJ01_120HZ =
{
	PanelName_SAMSUNG_LTI460HJ01_120HZ,	// Panel Name
	SAMSUNG_LTI460HJ01_120HZ,				// Panel ID (refer to enum defined in panel.h)
...
// @Modify By Ray --End-- 2010-04-26
	...
	Wa_OverDriveLUT_LTI460HJ01_120HZ, 	//OverDriveLut_LK520D3LZ8x,
	sRGB2rgb_LTI460HJ01_120HZ,
	Sta_GammaLUT_LTI460HJ01_120HZ,
	0,					//WORD  Invert_DVS 			: 1;
	0,					//WORD  Invert_DHS 			: 1;
...
extern ROM gmt_PanelData Panel_1080P_SAMSUNG_LTI460HJ01_120HZ;

#else
	#define Panel_1080P_SAMSUNG_LTI460HJ01_120HZ	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == SAMSUNG_LTI460HJ01_120HZ)
		#pragma message "Default panel will not bootup unless INCLUDE_SAMSUNG_LTI460HJ01_120HZ is defined!"
	#endif
#endif
