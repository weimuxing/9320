/*
	$Workfile:   LD470WUB_8BIT.h  $
	$Revision:   1.0  $
	$Date:   May 12 2008 09:51:18  $		//Peter 10090120
*/
#ifdef INCLUDE_LG_1080P_LD470WUB_8BIT

#include "..\..\Panel\1080P\LG\LD470WUB_8BIT\OverdriveLut.h"
#include "..\..\Panel\1080P\LG\LD470WUB_8BIT\GammaLut.h"


char ROM PanelName_LG_1080P_LD470WUB_8BIT[] = "LG_LD470WUB_8BIT";

ROM WORD sRGB2rgb_LD470WUB_8BIT[9] =
{
...
ROM gmt_PanelData Panel_1080P_LG_LD470WUB_8BIT =
{
	PanelName_LG_1080P_LD470WUB_8BIT,
	LG_1080P_LD470WUB_8BIT,			// Panel ID (refer to enum defined in panel.h)
	...
	Wa_OverDriveLUT_LD470WUB_8BIT,		// Overdrive look up table
	sRGB2rgb_LD470WUB_8BIT,
	Sta_GammaLUT_LG_LD470WUB_8BIT,
	0,									// WORD  Invert_DVS
	0,									// WORD  Invert_DHS
	0,									// WORD  Invert_DCLK
	0,									// WORD  Invert_DEN
...
extern ROM gmt_PanelData Panel_1080P_LG_LD470WUB_8BIT;

#else
	#define Panel_1080P_LG_LD470WUB_8BIT	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == LG_1080P_LD470WUB_8BIT)
		#pragma message "Default panel will not bootup unless INCLUDE_LG_1080P_LD470WUB_8BIT is defined!"
	#endif
#endif
