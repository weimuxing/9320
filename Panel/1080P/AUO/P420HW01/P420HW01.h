...
*/
#ifdef INCLUDE_AUO_1080P_P420HW01

#include "..\..\Panel\1080P\AUO\P420HW01\OverdriveLut.h"
#include "..\..\Panel\1080P\AUO\P420HW01\GammaLut.h"


char ROM PanelName_AUO_1080P_P420HW01[] = "AUO_P420HW01";

ROM WORD sRGB2rgb_P420HW01[9] =
{
...
ROM gmt_PanelData Panel_1080P_AUO_P420HW01 =
{
	PanelName_AUO_1080P_P420HW01,	// Panel Name
	AUO_1080P_P420HW01,				// Panel ID (refer to enum defined in panel.h)
...
// @Modify By Ray --End-- 2010-04-26
	...
	0x104,	//=>Andy Chiu 20110217  for MQE request  //0x105,	//=>Andy Chiu 20110103 for MQE request //0x603,//0x0,					//BYTE  SpreadSpectrumCtrl;		// Value for Spread_Spectrum_Control register
	0,					//BYTE  DClkDelay;		 		// DCLK display timing delay adjustment in ns unit.
	Wa_OverDriveLUT_P420HW01, 	//OverDriveLut_LK520D3LZ8x,
	sRGB2rgb_P420HW01,
	Sta_GammaLUT_P420HW01,
	0,					//WORD  Invert_DVS 			: 1;
	0,					//WORD  Invert_DHS 			: 1;
	...
	THREE_PT_SIX_MA, //=>Andy Chiu 20110804 for VID  //FIVE_PT_SIX_MA,	//=>Andy Chiu 20110120  for VCM SPEC V1.1-1.4  //FOUR_PT_SIX_MA,			//WORD  W_LvdsCurrentCtrl		: 2;			/
	OUT_24_48_BIT,			//WORD  W_BitOutput			: 1;
	0x0063,				//WORD	W_LvdsClkData
};
extern ROM gmt_PanelData Panel_1080P_AUO_P420HW01;

#else
	#define Panel_1080P_AUO_P420HW01	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == AUO_1080P_P420HW01)
		#pragma message "Default panel will not bootup unless INCLUDE_AUO_1080P_P420HW01 is defined!"
	#endif
#endif
