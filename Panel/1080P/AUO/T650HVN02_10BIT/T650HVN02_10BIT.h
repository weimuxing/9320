/*
	$Workfile:   T650HVN02_10BIT.h  $
	$Revision:   1.0  $
	$Date:   May 12 2008 09:51:18  $		//Peter 10090120
*/
#ifdef INCLUDE_AUO_1080P_T650HVN02_10BIT

#include "..\..\Panel\1080P\AUO\T650HVN02_10BIT\OverdriveLut.h"
#include "..\..\Panel\1080P\AUO\T650HVN02_10BIT\GammaLut.h"


char ROM PanelName_AUO_1080P_T650HVN02_10BIT[] = "AUO_T650HVN02_10BIT";

ROM WORD sRGB2rgb_T650HVN02_10BIT[9] =
{
...
ROM gmt_PanelData Panel_1080P_AUO_T650HVN02_10BIT =
{
	PanelName_AUO_1080P_T650HVN02_10BIT,
	AUO_1080P_T650HVN02_10BIT,			// Panel ID (refer to enum defined in panel.h)
	...
	Wa_OverDriveLUT_T650HVN02_10BIT,		// Overdrive look up table
	sRGB2rgb_T650HVN02_10BIT,
	Sta_GammaLUT_AUO_T650HVN02_10BIT,
	0,									// WORD  Invert_DVS
	0,									// WORD  Invert_DHS
	0,									// WORD  Invert_DCLK
	0,									// WORD  Invert_DEN
...
extern ROM gmt_PanelData Panel_1080P_AUO_T650HVN02_10BIT;

#else
	#define Panel_1080P_AUO_T650HVN02_10BIT	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == AUO_1080P_T650HVN02_10BIT)
		#pragma message "Default panel will not bootup unless AUO_1080P_T650HVN02_10BIT is defined!"
	#endif
#endif
