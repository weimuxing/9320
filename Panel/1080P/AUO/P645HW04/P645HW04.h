...
*/
#ifdef INCLUDE_AUO_P645HW04

#include "..\..\Panel\1080P\AUO\P645HW04\OverdriveLut.h"
#include "..\..\Panel\1080P\AUO\P645HW04\GammaLut.h"


char ROM PanelName_AUO_P645HW04[] = "AUO_P645HW04";

ROM WORD sRGB2rgb_P645HW04[9] =
{
...
ROM gmt_PanelData Panel_1080P_AUO_P645HW04 =
{
	PanelName_AUO_P645HW04,	// Panel Name
	AUO_P645HW04,				// Panel ID (refer to enum defined in panel.h)
	...
	2060,				//WORD  W_MinHTotal;
   	2200,//2080,       			//W_TypHTotal   
	2200,//2700,				//W_22HTotal
	2200,//2700,				//W_33HTotal
...
// @Modify By Ray --End-- 2010-04-26
	...
	0x604,	//0x1904,	// @Modify By Ray --Start-- 2010-12-30 modify SSC setting for EMI request. //0x603,//0x0,					//BYTE  SpreadSpectrumCtrl;		// Value for Spread_Spectrum_Control register
	0,					//BYTE  DClkDelay;		 		// DCLK display timing delay adjustment in ns unit.
	Wa_OverDriveLUT_P645HW04, 	//OverDriveLut_LK520D3LZ8x,
	sRGB2rgb_P645HW04,
	Sta_GammaLUT_P645HW04,
	0,					//WORD  Invert_DVS 			: 1;
	0,					//WORD  Invert_DHS 			: 1;
...
extern ROM gmt_PanelData Panel_1080P_AUO_P645HW04;

#else
	#define Panel_1080P_AUO_P645HW04	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == AUO_P645HW04)
		#pragma message "Default panel will not bootup unless INCLUDE_AUO_P645HW04 is defined!"
	#endif
#endif
