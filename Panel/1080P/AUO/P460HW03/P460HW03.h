...
*/
#ifdef INCLUDE_AUO_1080P_P460HW03

#include "..\..\Panel\1080P\AUO\P460HW03\OverdriveLut.h"
#include "..\..\Panel\1080P\AUO\P460HW03\GammaLut.h"


char ROM PanelName_AUO_1080P_P460HW03[] = "AUO_P460HW03";

ROM WORD sRGB2rgb_P460HW03[9] =
{
...
ROM gmt_PanelData Panel_1080P_AUO_P460HW03 =
{
	PanelName_AUO_1080P_P460HW03,	// Panel Name
	AUO_1080P_P460HW03,				// Panel ID (refer to enum defined in panel.h)
...
// @Modify By Ray --End-- 2010-04-26
	...
	Wa_OverDriveLUT_P460HW03, 	//OverDriveLut_LK520D3LZ8x,
	sRGB2rgb_P460HW03,
	Sta_GammaLUT_P460HW03,
	0,					//WORD  Invert_DVS 			: 1;
	0,					//WORD  Invert_DHS 			: 1;
	...
	FOUR_PT_SIX_MA,	//THREE_PT_SIX_MA, // @Modify By Ray --Start-- 2011-08-23 modify VID for 46".//=>Andy Chiu 20110804 for VID  //FOUR_PT_SIX_MA,			//WORD  W_LvdsCurrentCtrl		: 2;			/
	OUT_24_48_BIT,			//WORD  W_BitOutput			: 1;
	0x0063,				//WORD	W_LvdsClkData
};
extern ROM gmt_PanelData Panel_1080P_AUO_P460HW03;

#else
	#define Panel_1080P_AUO_P460HW03	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == AUO_1080P_P460HW03)
		#pragma message "Default panel will not bootup unless INCLUDE_AUO_1080P_P460HW03 is defined!"
	#endif
#endif
