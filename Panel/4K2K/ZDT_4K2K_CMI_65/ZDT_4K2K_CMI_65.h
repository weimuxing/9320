...
#ifdef INCLUDE_ZDT_4K2K_CMI_65

#include "..\..\Panel\4K2K\ZDT_4K2K_CMI_65\OverdriveLut.h"
#include "..\..\Panel\4K2K\ZDT_4K2K_CMI_65\GammaLut.h"

char ROM PanelName_ZDT_4K2K_CMI_65[] = "ZDT_4K2K_CMI_65";

ROM WORD sRGB2rgb_ZDT_4K2K_CMI_65[9] =
{
...
ROM gmt_PanelData Panel_ZDT_4K2K_CMI_65 =
{
	PanelName_ZDT_4K2K_CMI_65,
	ZDT_4K2K_CMI_65,			// Panel ID (refer to enum defined in panel.h)
	...
	Wa_OverDriveLUT_ZDT_4K2K_CMI_65,		// Overdrive look up table
	sRGB2rgb_ZDT_4K2K_CMI_65,
	Sta_GammaLUT_ZDT_4K2K_CMI_65,
	0,									// WORD  Invert_DVS
	0,									// WORD  Invert_DHS
	0,									// WORD  Invert_DCLK
	0,									// WORD  Invert_DEN
...
extern ROM gmt_PanelData Panel_ZDT_4K2K_CMI_65;

#else
	#define Panel_ZDT_4K2K_CMI_65	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == ZDT_4K2K_CMI_65)
		#pragma message "Default panel will not bootup unless INCLUDE_ZDT_4K2K_CMI_65 is defined!"
	#endif
#endif
