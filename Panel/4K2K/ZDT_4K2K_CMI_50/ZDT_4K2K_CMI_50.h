...
#ifdef INCLUDE_ZDT_4K2K_CMI_50

#include "..\..\Panel\4K2K\ZDT_4K2K_CMI_50\OverdriveLut.h"
#include "..\..\Panel\4K2K\ZDT_4K2K_CMI_50\GammaLut.h"

char ROM PanelName_ZDT_4K2K_CMI_50[] = "ZDT_4K2K_CMI_50";

ROM WORD sRGB2rgb_ZDT_4K2K_CMI_50[9] =
{
...
ROM gmt_PanelData Panel_ZDT_4K2K_CMI_50 =
{
	PanelName_ZDT_4K2K_CMI_50,
	ZDT_4K2K_CMI_50,			// Panel ID (refer to enum defined in panel.h)
	...
	0xFF10,//0x1101,								// WORD  PowerUpTiming
	...
	0,//Wa_OverDriveLUT_ZDT_4K2K_CMI_50,		// Overdrive look up table
	sRGB2rgb_ZDT_4K2K_CMI_50,
	0,//Sta_GammaLUT_ZDT_4K2K_CMI_50,
	0,									// WORD  Invert_DVS
	0,									// WORD  Invert_DHS
	0,									// WORD  Invert_DCLK
	0,									// WORD  Invert_DEN
...
extern ROM gmt_PanelData Panel_ZDT_4K2K_CMI_50;

#else
	#define Panel_ZDT_4K2K_CMI_50	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == ZDT_4K2K_CMI_50)
		#pragma message "Default panel will not bootup unless INCLUDE_ZDT_4K2K_CMI_50 is defined!"
	#endif
#endif
