...
#ifdef INCLUDE_ZDT_4K2K_QFHD

#include "..\..\Panel\4K2K\ZDT_4K2K\OverdriveLut.h"
#include "..\..\Panel\4K2K\ZDT_4K2K\GammaLut.h"

char ROM PanelName_ZDT_4K2K_QFHD[] = "ZDT_4K2K_QFHD";

ROM WORD sRGB2rgb_ZDT_4K2K_QFHD[9] =
{
...
ROM gmt_PanelData Panel_ZDT_4K2K_QFHD =
{
	PanelName_ZDT_4K2K_QFHD,
	ZDT_4K2K_QFHD,			// Panel ID (refer to enum defined in panel.h)
	...
	0, //Wa_OverDriveLUT_ZDT_4K2K,		// Overdrive look up table
	0,//sRGB2rgb_ZDT_4K2K_QFHD,
	0,//Sta_GammaLUT_ZDT_4K2K,
	0,									// WORD  Invert_DVS
	0,									// WORD  Invert_DHS
	0,									// WORD  Invert_DCLK
	0,									// WORD  Invert_DEN
...
extern ROM gmt_PanelData Panel_ZDT_4K2K_QFHD;

#else
	#define Panel_ZDT_4K2K_QFHD	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == ZDT_4K2K_QFHD)
		#pragma message "Default panel will not bootup unless INCLUDE_ZDT_4K2K_QFHD is defined!"
	#endif
#endif
