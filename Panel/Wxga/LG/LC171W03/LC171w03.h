...
#ifdef INCLUDE_LG_WXGA_LC171W03

#include "..\..\Panel\Wxga\LG\LC171W03\OverdriveLut.h"
#include "..\..\Panel\Wxga\LG\LC171W03\GammaLut.h"

char ROM PanelName_WXGA_LC171W03[] = "LG_LC171_W03";

ROM WORD sRGB2rgb_LC171W03[9] =
{
...
ROM gmt_PanelData Panel_LG_WXGA_LC171W03 =
{
	PanelName_WXGA_LC171W03,// Panel Name
	LG_WXGA_LC171W03,	// Panel ID (refer to enum defined in panel.h)
	...
	Wa_OverDriveLUT_LC171W03, //OverDriveLut_LC171W03,
	sRGB2rgb_LC171W03,
	Sta_GammaLUT_LC171W03,
	0,					//WORD  Invert_DVS 				: 1;
	0,					//WORD  Invert_DHS 				: 1;
...
extern ROM gmt_PanelData Panel_LG_WXGA_LC171W03;

#else
	#define Panel_LG_WXGA_LC171W03	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == LG_WXGA_LC171W03)
		#pragma message "Default panel will not bootup unless INCLUDE_LG_WXGA_LC171W03 is defined!"
	#endif
#endif
