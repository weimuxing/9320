/*
	$Workfile:   LM300WQ5_SLA1.h  $
	$Revision: 1.6 $
	$Date: 2011/06/17 04:37:16 $
*/

#ifdef INCLUDE_LG_WQXGA_LM300WQ5_SLA1

#include "..\..\Panel\WQXGA\LG\LM300WQ5_SLA1\OverdriveLut.h"
#include "..\..\Panel\WQXGA\LG\LM300WQ5_SLA1\GammaLut.h"

char ROM PanelName_LM300WQ5_SLA1[] = "LG_WQXGA_LM300WQ5_SLA1";

ROM WORD sRGB2rgb_LM300WQ5_SLA1[9] =
{
...
ROM gmt_PanelData Panel_LG_WQXGA_LM300WQ5_SLA1 =
{
	PanelName_LM300WQ5_SLA1,
	LG_WQXGA_LM300WQ5_SLA1,			// Panel ID (refer to enum defined in panel.h)
	...
	Wa_OverDriveLUT_LM300WQ5_SLA1,		// Overdrive look up table
	sRGB2rgb_LM300WQ5_SLA1,
	Sta_GammaLUT_LM300WQ5_SLA1,
	0,									// WORD  Invert_DVS
	0,									// WORD  Invert_DHS
	0,									// WORD  Invert_DCLK
	0,									// WORD  Invert_DEN
...
extern ROM gmt_PanelData Panel_LG_WQXGA_LM300WQ5_SLA1;

#else
	#define Panel_LG_WQXGA_LM300WQ5_SLA1	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == LG_WQXGA_LM300WQ5_SLA1)
		#pragma message "Default panel will not bootup unless INCLUDE_LG_WQXGA_LM300WQ5_SLA1 is defined!"
	#endif
#endif
