...
VQ_ACM_Parameters_t ROM ACM_Params_Multimedia_Graphic = 
{
		...
		8,	// Number of active regions
	{
		...
		{221,	9, 578, 2344, 273, 3003,  16,  64,	80},
		{  0,  11, 578, 2312, 273, 3051,  14, 162, 288},
		{170,	8, 280, 2890, 273, 3380,   5,  64,	80},
		{142,	8, 706, 2601, 273, 3003,   5,  32,	80},
		{ 54,	6, 289, 2312, 417, 3003,   6,  64,	80},
		{103,	7, 578, 2328, 273, 3822,  12,  64,	80},
		{117,	7, 581, 2312, 273, 1911,  11,  16,	80},
	},
	{
		// hue_offset, hue_gain, sat_offset, sat_gain, lum_offset, lum_gain, u_vect, v_vect, alpha
		{ -5,	0,	55,  64,   0,  64,	 0,   0,  16},
		{  5,	0,	55,  64,   0,  59,	 0,   0,  16},
		{  0,	0,	22,  62,   0,  73,	 0,   0,  16},
		{ -3,	0,	 0,  64,   0,  64,	 0,   0,  16},
		{ -6,	0,	22,  64,   0,  64,	 0,   0,  16},
		{  0,	0, -12,  56, 100,  65,	 0,   0,  16},
...
VQ_ACM_Parameters_t ROM ACM_Params_Game_Graphic = 
{
		...
		8,	// Number of active regions
	{
		...
		{128,	8, 578, 2601, 273, 3003,   5,	0,	80},
		{ 48,	5, 368, 2312, 321, 3003,  10,  22,	80},
		{105,	7, 385, 2601, 273, 3822,  12,	0,	80},
		{260,	8, 449, 2344,  64, 1911,  13,  48,	80},
	},
	{
		// hue_offset, hue_gain, sat_offset, sat_gain, lum_offset, lum_gain, u_vect, v_vect, alpha
		{-10,	0,	22,  64,   0,  61,	 0,   0,  16},
		{ -4,	0,	55,  64,   0,  64,	 0,   0,  16},
		{  0,	0,	 0,  62,   0,  58,	 0,   0,  16},
		{ -4,	0,	44,  64,   0,  62,	 0,   0,  16},
		{  0,	0,	 0,  64,   0,  64,	 0,   0,  16},
		{  1,	0,	 0,  58,   0,  62,	 0,   0,  16},
		{ -3,	0,	22,  56,   0,  62,	 0,   0,  16},
		{  0,	0,	 0,  64,   0,  64,	 0,   0,  16},
	}
} ;
...
VQ_ACM_Parameters_t ROM ACM_Params_Movie_Graphic = 
{
	...
	{
		// W_HueCenter, B_HueAperture, B_R1, B_R2, B_Y1, B_Y2, B_HueFade, B_SatFade, B_LumiFade
		{290,  10, 578, 2312, 273, 3099,  14, 373, 288},
		{224,  11, 337, 2488, 273, 3131,  16, 162, 320},
		{350,  13, 417, 2312, 144, 3051,   9, 162, 288},
		{189,	8, 353, 2681, 289, 3147,  22, 227, 320},
		{164,	8, 280, 2697, 321, 3380,  14, 194, 448},
		{104,	5, 289, 2408, 273, 3051,  15,  97, 240},
		{122,	5, 289, 1477, 273, 3822,  14,  80, 240},
		{ 51,	4, 289, 2633, 273, 2922,  12,  80, 320},
	},
	{
		// hue_offset, hue_gain, sat_offset, sat_gain, lum_offset, lum_gain, u_vect, v_vect, alpha
		{  0,	2, 100,  65,   0,  60,	 0,   0,  16},
		{  0,	0,	 0,  64,  80,  64,	 0,   0,  16},
		{ -5,	0,	22,  62,   0,  64,	 0,   0,  16},
		{-15,	0,	 0,  64, 176,  64,	 0,   0,  16},
		{ -3,	0,	 0,  62,   0,  60,	 0,   0,  16},
		{ -3,	0,	11,  64,   0,  60,	 0,   0,  16},
		{ -6,	0,	33,  64,   0,  62,	 0,   0,  16},
		{  0,	0,	 0,  58, 100,  64,	 0,   0,  16},
	}
} ;
