/*
	$Workfile:   NLT_NL204153AM21.h  $
	$Revision: 1.1 $
	$Date: 2012/02/20 01:53:30 $
*/

#ifdef INCLUDE_NLT_NL204153AM21

#include "..\..\Panel\2K2K\NLT\NLT_NL204153AM21\OverdriveLut.h"
#include "..\..\Panel\2K2K\NLT\NLT_NL204153AM21\GammaLut.h"


char ROM PanelName_NLT_NL204153AM21[] = "NLT_NL204153AM21";

ROM WORD sRGB2rgb_NLT_NL204153AM21[9] =
{
...
ROM gmt_PanelData Panel_2K2K_NLT_NL204153AM21 =
{
	PanelName_NLT_NL204153AM21,
	NLT_NL204153AM21,						// Panel ID (refer to enum defined in panel.h)
	...
	60,									// BYTE  MaxVFreq
	57,									// BYTE  MinVFreq
	132000UL,//264000L,							// DWORD MaxPClk (KHz)  
	2688,								// WORD W_MinHTotal
	2688,								// W_TypHTotal
	2688,								// W_22HTotal
	2688,								// W_33HTotal
	...
	Wa_OverDriveLUT_NLT_NL204153AM21,		// Overdrive look up table
	sRGB2rgb_NLT_NL204153AM21,
	Sta_GammaLUT_NLT_NL204153AM21,
	0,									// WORD  Invert_DVS
	0,									// WORD  Invert_DHS
	0,									// WORD  Invert_DCLK
	0,									// WORD  Invert_DEN
...
extern ROM gmt_PanelData Panel_2K2K_NLT_NL204153AM21;

#else
	#define Panel_2K2K_NLT_NL204153AM21	(ROM gmt_PanelData *)PanelArray
	//
	// If panel file is not included in the project, but the panel is selected to be
	// the default panel during bootup, issue warning message
	//
	#if (DEFAULT_PANEL == NLT_NL204153AM21)
